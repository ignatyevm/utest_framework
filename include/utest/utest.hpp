...
namespace utest {
    namespace detail {
        ...
        inline void register_assert(std::string_view test_name, std::string_view condition, bool condition_value,
    ...
    inline int run_tests() {
        ...
        std::cerr << "========== Passed " << passed_tests << "/" << detail::tests.size() << " tests =========="
                  << std::endl;
